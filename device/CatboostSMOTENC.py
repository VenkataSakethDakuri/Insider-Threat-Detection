...
#SMOTENC cant work with only categorical features, so adding sinusoidal features for hour
...
X_train_resampled, y_train_resampled = smote_balancer.fit_resample(X_train, y_train)
