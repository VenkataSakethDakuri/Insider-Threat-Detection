...
rf_classifier = RandomForestClassifier(n_estimators=100, random_state=108, class_weight='balanced', max_depth=10)
...
# Results with sin and cos features. hour removed.
# Accuracy: 0.9727
# Precision: 0.1126
# Recall: 0.3236
# AUC: 0.7919
